    ...
    >
      <q-scroll-area class="fit">
        <q-list>
          ...
          <q-item clickable active-class="active" v-ripple exact :to="{ name: 'dataTugas' } ">
            <q-item-section avatar>
              <q-icon name="dashboard"/>
            </q-item-section>
            <q-item-section>
              <q-item-label>Data Tugas</q-item-label>
            </q-item-section>
          </q-item>
          <q-item clickable active-class="active" v-ripple exact :to="{ name: 'inputTugas' } ">
            <q-item-section avatar>
              <q-icon name="input"/>
            </q-item-section>
            <q-item-section>
              <q-item-label>Input Tugas</q-item-label>
            </q-item-section>
          </q-item>
